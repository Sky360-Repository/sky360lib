...
WeightedMovingVarianceHalide::WeightedMovingVarianceHalide(bool _enableWeight,
    ...
    : CoreBgs(1),//_numProcessesParallel),
...
void WeightedMovingVarianceHalide::getBackgroundImage(cv::Mat &_bgImage)
{
}

void WeightedMovingVarianceHalide::initialize(const cv::Mat &_image)
{
    initParallelData();
    initHalide();
}
