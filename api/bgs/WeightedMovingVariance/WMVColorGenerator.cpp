...
namespace
{
    class WMVColorGenerator : public Halide::Generator<WMVColorGenerator>
    {
    public:
        ...
        void generate()
        {
            ...
            output(x, y) = cast<uint8_t>(sqrt(result(x, y)));
...
HALIDE_REGISTER_GENERATOR(WMVColorGenerator, wmv_color)
